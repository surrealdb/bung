...
use bung::decode::Error;
use bung::Deserializer;
...
fn fail_enum_map_mismatch() {
	...
	let err: Result<Enum, _> = bung::from_slice(&buf);
...
fn pass_enum_custom_policy() {
	use bung::decode::VariantVisitor;
	use std::io::Read;
